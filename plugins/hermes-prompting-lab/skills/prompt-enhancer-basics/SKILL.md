---
name: prompt-enhancer-basics
description: "Plain-language Hermes tutorial content for Prompt Enhancer Basics."
version: 0.1.0
author: Kiren Srinivasan
license: Apache-2.0
---

# Prompt Enhancer Basics

This bundled tutorial skill belongs to `hermes-prompting-lab`.

## Purpose

Good Hermes prompts define objective, context, write scope, source-of-truth checks, and validation threshold.
