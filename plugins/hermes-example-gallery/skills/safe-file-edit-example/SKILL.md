---
name: safe-file-edit-example
description: "Plain-language Hermes tutorial content for Safe File Edit Example."
version: 0.1.0
author: Kiren Srinivasan
license: Apache-2.0
---

# Safe File Edit Example

This bundled tutorial skill belongs to `hermes-example-gallery`.

## Purpose

Start from a safe recipe, customize only the placeholders, then validate with live Hermes output.
