---
name: terminal-safety-practice
description: "Plain-language Hermes tutorial content for Terminal Safety Practice."
version: 0.1.0
author: Kiren Srinivasan
license: Apache-2.0
---

# Terminal Safety Practice

This bundled tutorial skill belongs to `hermes-tools-lab`.

## Purpose

Tools are capabilities, not toys: use the smallest safe toolset that proves the task.
