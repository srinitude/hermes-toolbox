---
name: session-search-basics
description: "Plain-language Hermes tutorial content for Session Search Basics."
version: 0.1.0
author: Kiren Srinivasan
license: Apache-2.0
---

# Session Search Basics

This bundled tutorial skill belongs to `hermes-memory-lab`.

## Purpose

Save durable facts in memory, retrieve past task context with session search, and keep procedures in skills.
