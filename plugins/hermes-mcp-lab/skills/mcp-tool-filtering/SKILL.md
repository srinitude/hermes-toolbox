---
name: mcp-tool-filtering
description: "Plain-language Hermes tutorial content for Mcp Tool Filtering."
version: 0.1.0
...
This bundled tutorial skill belongs to `hermes-mcp-lab`.

## Purpose

Prefer MCP for external tool ecosystems with existing servers; prefer plugins for Hermes-native capabilities.
