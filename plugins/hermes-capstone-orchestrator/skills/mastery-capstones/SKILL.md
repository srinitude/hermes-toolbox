---
name: mastery-capstones
description: "Plain-language Hermes tutorial content for Mastery Capstones."
version: 0.1.0
...
This bundled tutorial skill belongs to `hermes-capstone-orchestrator`.

## Purpose

Capstones prove that a learner can combine Hermes primitives safely, explain tradeoffs, and validate results.
