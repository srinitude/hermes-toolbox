---
name: do-not-confuse-cards
description: "Plain-language Hermes tutorial content for Do Not Confuse Cards."
version: 0.1.0
author: Kiren Srinivasan
license: Apache-2.0
---

# Do Not Confuse Cards

This bundled tutorial skill belongs to `hermes-concept-glossary`.

## Purpose

Learn core Hermes words before following procedures that depend on them.
