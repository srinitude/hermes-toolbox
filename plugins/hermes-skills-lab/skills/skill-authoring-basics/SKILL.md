---
name: skill-authoring-basics
description: "Plain-language Hermes tutorial content for Skill Authoring Basics."
version: 0.1.0
...
This bundled tutorial skill belongs to `hermes-skills-lab`.

## Purpose

Use skills for reusable procedures and checklists; use plugins only when Hermes needs new capabilities.
