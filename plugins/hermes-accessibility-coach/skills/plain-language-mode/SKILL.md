...
description: "Plain-language Hermes tutorial content for Plain Language Mode."
version: 0.1.0
...
This bundled tutorial skill belongs to `hermes-accessibility-coach`.

## Purpose

Ask Hermes to slow down, define jargon, and summarize each step when learning a new concept.
