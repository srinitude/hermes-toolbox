...
description: "Plain-language Hermes tutorial content for Plugin Debugging."
version: 0.1.0
...
This bundled tutorial skill belongs to `hermes-troubleshooting-lab`.

## Purpose

Start with `hermes doctor`, `hermes status`, targeted logs, and the exact command that failed.
