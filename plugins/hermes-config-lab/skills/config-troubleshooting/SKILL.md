...
description: "Plain-language Hermes tutorial content for Config Troubleshooting."
version: 0.1.0
...
Use `hermes config` for non-secret settings and setup/auth flows for secrets.
