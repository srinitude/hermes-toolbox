---
name: plugin-builder-basics
description: "Plain-language Hermes tutorial content for Plugin Builder Basics."
version: 0.1.0
author: Kiren Srinivasan
license: Apache-2.0
---

# Plugin Builder Basics

This bundled tutorial skill belongs to `hermes-plugin-builder-lab`.

## Purpose

Choose the lightest correct extension surface before writing plugin code; validate manifest, register APIs, handler JSON contracts, and load behavior.
