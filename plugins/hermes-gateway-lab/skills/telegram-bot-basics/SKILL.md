...
description: "Plain-language Hermes tutorial content for Telegram Bot Basics."
version: 0.1.0
...
This bundled tutorial skill belongs to `hermes-gateway-lab`.

## Purpose

A bot with terminal tools needs strict authorization, pairing, and allowlists before it should be trusted.
