...
description: "Plain-language Hermes tutorial content for Intermediate Path."
version: 0.1.0
...
This bundled tutorial skill belongs to `hermes-tutorial-compass`.

## Purpose

Use the tutorial compass to choose a path, inspect prerequisites, and understand what mastery means at each level.
