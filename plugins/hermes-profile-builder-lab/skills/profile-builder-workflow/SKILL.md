---
name: profile-builder-workflow
description: "Plain-language Hermes tutorial content for Profile Builder Workflow."
version: 0.1.0
...
This bundled tutorial skill belongs to `hermes-profile-builder-lab`.

## Purpose

Map each goal to profile primitives: identity, model, configuration, terminal, tools, skills, memory, automation, safety, performance, validation, and portability.
