---
name: tui-basics
description: "Plain-language Hermes tutorial content for Tui Basics."
version: 0.1.0
...
This bundled tutorial skill belongs to `hermes-command-lab`.

## Purpose

Practice safe commands such as `hermes --help`, `/help`, `/status`, and read-only inspection before changing settings.
