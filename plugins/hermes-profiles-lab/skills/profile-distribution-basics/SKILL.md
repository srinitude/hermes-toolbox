---
name: profile-distribution-basics
description: "Plain-language Hermes tutorial content for Profile Distribution Basics."
version: 0.1.0
author: Kiren Srinivasan
license: Apache-2.0
---

# Profile Distribution Basics

This bundled tutorial skill belongs to `hermes-profiles-lab`.

## Purpose

A profile has its own Hermes home; its working directory and system sandbox are separate choices.
