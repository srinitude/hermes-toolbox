---
name: self-contained-cron-prompts
description: "Plain-language Hermes tutorial content for Self Contained Cron Prompts."
version: 0.1.0
author: Kiren Srinivasan
license: Apache-2.0
---

# Self Contained Cron Prompts

This bundled tutorial skill belongs to `hermes-cron-automation-lab`.

## Purpose

Cron jobs run in fresh sessions with self-contained prompts; TUI-local jobs do not live-deliver back into the TUI.
