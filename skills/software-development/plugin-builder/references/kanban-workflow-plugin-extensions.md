...
- user-specific/private plugins route through the `<first-name>-plugins` workshop profile and use a `<first-name>-` prefix.
- Reusable/non-user-specific plugins route through the `non-<first-name>-plugins` workshop profile and keep docs/examples identity-neutral.
