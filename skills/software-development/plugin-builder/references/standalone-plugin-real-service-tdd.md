...
- Redact quoted and unquoted Basic/Bearer credentials, folded authorization and cookie headers, and complete multipart cookie or set-cookie field values. Tests must assert that synthetic payload markers—not merely control bytes—are absent.
