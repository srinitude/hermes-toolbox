...
- Public tracked content should be identity-neutral by default except approved `author: <repo-author-name>` skill metadata and approved repo-local Git identity.
