...
- `security`: avoid publishing private/person-specific profile repositories or copying secrets/runtime artifacts.
...
1. A profile workspace under the deployment's approved user-specific or reusable workspace convention.
